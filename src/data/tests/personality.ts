...
// 5 个维度: O(开放性) C(尽责性) E(外向性) A(亲和性) N(神经质)
// 12 种结论: 由各维度高/低分组合推导
// ───────────────────────────────────────────────
...
export const personalityTest: TestSuite = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { id: 'q06a', label: '非常符合', scores: { O: 0 } },
        { id: 'q06b', label: '比较符合', scores: { O: 1 } },
        { id: 'q06c', label: '有点符合', scores: { O: 2 } },
        { id: 'q06d', label: '不太符合', scores: { O: 3 } },
        { id: 'q06e', label: '完全不符合', scores: { O: 4 } }
      ]
    },
    ...
    // ── 尽责性 (C) ── 6题
    {
      ...
      options: [
        { id: 'q07a', label: '非常符合', scores: { C: 4 } },
        { id: 'q07b', label: '比较符合', scores: { C: 3 } },
        { id: 'q07c', label: '有点符合', scores: { C: 2 } },
        { id: 'q07d', label: '不太符合', scores: { C: 1 } },
        { id: 'q07e', label: '完全不符合', scores: { C: 0 } }
      ]
    },
    {
      id: 'q08',
      ...
      options: [
        { id: 'q08a', label: '非常符合', scores: { C: 4 } },
        { id: 'q08b', label: '比较符合', scores: { C: 3 } },
        { id: 'q08c', label: '有点符合', scores: { C: 2 } },
        { id: 'q08d', label: '不太符合', scores: { C: 1 } },
        { id: 'q08e', label: '完全不符合', scores: { C: 0 } }
      ]
    },
    {
      id: 'q09',
      dimension: 'C',
      text: '面对截止日期，我总是提前完成，绝不拖到最后一刻。',
      options: [
        { id: 'q09a', label: '非常符合', scores: { C: 4 } },
        { id: 'q09b', label: '比较符合', scores: { C: 3 } },
        { id: 'q09c', label: '有点符合', scores: { C: 2 } },
        { id: 'q09d', label: '不太符合', scores: { C: 1 } },
        { id: 'q09e', label: '完全不符合', scores: { C: 0 } }
      ]
    },
    {
      id: 'q10',
      ...
      options: [
        { id: 'q10a', label: '非常符合', scores: { C: 4 } },
        { id: 'q10b', label: '比较符合', scores: { C: 3 } },
        { id: 'q10c', label: '有点符合', scores: { C: 2 } },
        { id: 'q10d', label: '不太符合', scores: { C: 1 } },
        { id: 'q10e', label: '完全不符合', scores: { C: 0 } }
      ]
    },
    {
      id: 'q11',
      ...
      options: [
        { id: 'q11a', label: '非常符合', scores: { C: 0 } },
        { id: 'q11b', label: '比较符合', scores: { C: 1 } },
        { id: 'q11c', label: '有点符合', scores: { C: 2 } },
        { id: 'q11d', label: '不太符合', scores: { C: 3 } },
        { id: 'q11e', label: '完全不符合', scores: { C: 4 } }
      ]
    },
    {
      id: 'q12',
    ...
    // ── 外向性 (E) ── 6题
    {
      ...
      options: [
        { id: 'q13a', label: '非常符合', scores: { E: 4 } },
        { id: 'q13b', label: '比较符合', scores: { E: 3 } },
        { id: 'q13c', label: '有点符合', scores: { E: 2 } },
        { id: 'q13d', label: '不太符合', scores: { E: 1 } },
        { id: 'q13e', label: '完全不符合', scores: { E: 0 } }
      ]
    },
    {
      id: 'q14',
      ...
      options: [
        { id: 'q14a', label: '非常符合', scores: { E: 4 } },
        { id: 'q14b', label: '比较符合', scores: { E: 3 } },
        { id: 'q14c', label: '有点符合', scores: { E: 2 } },
        { id: 'q14d', label: '不太符合', scores: { E: 1 } },
        { id: 'q14e', label: '完全不符合', scores: { E: 0 } }
      ]
    },
    {
      id: 'q15',
      ...
      options: [
        { id: 'q15a', label: '非常符合', scores: { E: 4 } },
        { id: 'q15b', label: '比较符合', scores: { E: 3 } },
        { id: 'q15c', label: '有点符合', scores: { E: 2 } },
        { id: 'q15d', label: '不太符合', scores: { E: 1 } },
        { id: 'q15e', label: '完全不符合', scores: { E: 0 } }
      ]
    },
    {
      id: 'q16',
      ...
      options: [
        { id: 'q16a', label: '非常符合', scores: { E: 0 } },
        { id: 'q16b', label: '比较符合', scores: { E: 1 } },
        { id: 'q16c', label: '有点符合', scores: { E: 2 } },
        { id: 'q16d', label: '不太符合', scores: { E: 3 } },
        { id: 'q16e', label: '完全不符合', scores: { E: 4 } }
      ]
    },
    {
      id: 'q17',
      ...
      options: [
        { id: 'q17a', label: '非常符合', scores: { E: 4 } },
        { id: 'q17b', label: '比较符合', scores: { E: 3 } },
        { id: 'q17c', label: '有点符合', scores: { E: 2 } },
        { id: 'q17d', label: '不太符合', scores: { E: 1 } },
        { id: 'q17e', label: '完全不符合', scores: { E: 0 } }
      ]
    },
    {
      id: 'q18',
      ...
      options: [
        { id: 'q18a', label: '非常符合', scores: { E: 4 } },
        { id: 'q18b', label: '比较符合', scores: { E: 3 } },
        { id: 'q18c', label: '有点符合', scores: { E: 2 } },
        { id: 'q18d', label: '不太符合', scores: { E: 1 } },
        { id: 'q18e', label: '完全不符合', scores: { E: 0 } }
      ]
    },
    ...
    // ── 亲和性 (A) ── 6题
    {
      ...
      options: [
        { id: 'q19a', label: '非常符合', scores: { A: 4 } },
        { id: 'q19b', label: '比较符合', scores: { A: 3 } },
        { id: 'q19c', label: '有点符合', scores: { A: 2 } },
        { id: 'q19d', label: '不太符合', scores: { A: 1 } },
        { id: 'q19e', label: '完全不符合', scores: { A: 0 } }
      ]
    },
    {
      id: 'q20',
      dimension: 'A',
      text: '我宁愿妥协退让，也不想与别人产生冲突。',
      options: [
        { id: 'q20a', label: '非常符合', scores: { A: 4 } },
        { id: 'q20b', label: '比较符合', scores: { A: 3 } },
        { id: 'q20c', label: '有点符合', scores: { A: 2 } },
        { id: 'q20d', label: '不太符合', scores: { A: 1 } },
        { id: 'q20e', label: '完全不符合', scores: { A: 0 } }
      ]
    },
    {
      id: 'q21',
      ...
      options: [
        { id: 'q21a', label: '非常符合', scores: { A: 4 } },
        { id: 'q21b', label: '比较符合', scores: { A: 3 } },
        { id: 'q21c', label: '有点符合', scores: { A: 2 } },
        { id: 'q21d', label: '不太符合', scores: { A: 1 } },
        { id: 'q21e', label: '完全不符合', scores: { A: 0 } }
      ]
    },
    {
      id: 'q22',
      dimension: 'A',
      text: '我很少在意别人的感受，更关注结果是否达到预期。',
      options: [
        { id: 'q22a', label: '非常符合', scores: { A: 0 } },
        { id: 'q22b', label: '比较符合', scores: { A: 1 } },
        { id: 'q22c', label: '有点符合', scores: { A: 2 } },
        { id: 'q22d', label: '不太符合', scores: { A: 3 } },
        { id: 'q22e', label: '完全不符合', scores: { A: 4 } }
      ]
    },
    {
      id: 'q23',
      ...
      options: [
        { id: 'q23a', label: '非常符合', scores: { A: 4 } },
        { id: 'q23b', label: '比较符合', scores: { A: 3 } },
        { id: 'q23c', label: '有点符合', scores: { A: 2 } },
        { id: 'q23d', label: '不太符合', scores: { A: 1 } },
        { id: 'q23e', label: '完全不符合', scores: { A: 0 } }
      ]
    },
    {
      id: 'q24',
      ...
      options: [
        { id: 'q24a', label: '非常符合', scores: { A: 4 } },
        { id: 'q24b', label: '比较符合', scores: { A: 3 } },
        { id: 'q24c', label: '有点符合', scores: { A: 2 } },
        { id: 'q24d', label: '不太符合', scores: { A: 1 } },
        { id: 'q24e', label: '完全不符合', scores: { A: 0 } }
      ]
    },
    ...
    // ── 情绪稳定性 (N, 反向计分) ── 6题
    {
      id: 'q25',
      dimension: 'N',
      text: '面对突发变故，我通常能很快冷静下来，制定应对方案。',
      options: [
        { id: 'q25a', label: '非常符合', scores: { N: 4 } },
        { id: 'q25b', label: '比较符合', scores: { N: 3 } },
        { id: 'q25c', label: '有点符合', scores: { N: 2 } },
        { id: 'q25d', label: '不太符合', scores: { N: 1 } },
        { id: 'q25e', label: '完全不符合', scores: { N: 0 } }
      ]
    },
    {
      id: 'q26',
      dimension: 'N',
      text: '被批评或否定后，我很少过多纠结，能迅速调整心态继续前行。',
      options: [
        { id: 'q26a', label: '非常符合', scores: { N: 4 } },
        { id: 'q26b', label: '比较符合', scores: { N: 3 } },
        { id: 'q26c', label: '有点符合', scores: { N: 2 } },
        { id: 'q26d', label: '不太符合', scores: { N: 1 } },
        { id: 'q26e', label: '完全不符合', scores: { N: 0 } }
      ]
    },
    {
      id: 'q27',
      dimension: 'N',
      text: '即便事情出了问题，我也很少陷入自我怀疑或焦虑的情绪中。',
      options: [
        { id: 'q27a', label: '非常符合', scores: { N: 4 } },
        { id: 'q27b', label: '比较符合', scores: { N: 3 } },
        { id: 'q27c', label: '有点符合', scores: { N: 2 } },
        { id: 'q27d', label: '不太符合', scores: { N: 1 } },
        { id: 'q27e', label: '完全不符合', scores: { N: 0 } }
      ]
    },
    {
      id: 'q28',
      dimension: 'N',
      text: '我的情绪容易因外界因素而大起大落，难以自控。',
      options: [
        { id: 'q28a', label: '非常符合', scores: { N: 0 } },
        { id: 'q28b', label: '比较符合', scores: { N: 1 } },
        { id: 'q28c', label: '有点符合', scores: { N: 2 } },
        { id: 'q28d', label: '不太符合', scores: { N: 3 } },
        { id: 'q28e', label: '完全不符合', scores: { N: 4 } }
      ]
    },
    {
      id: 'q29',
      dimension: 'N',
      text: '在压力非常大的环境下，我仍能保持较高的工作效率和思维清晰度。',
      options: [
        { id: 'q29a', label: '非常符合', scores: { N: 4 } },
        { id: 'q29b', label: '比较符合', scores: { N: 3 } },
        { id: 'q29c', label: '有点符合', scores: { N: 2 } },
        { id: 'q29d', label: '不太符合', scores: { N: 1 } },
        { id: 'q29e', label: '完全不符合', scores: { N: 0 } }
      ]
    },
    {
      id: 'q30',
      ...
      options: [
        { id: 'q30a', label: '非常符合', scores: { N: 4 } },
        { id: 'q30b', label: '比较符合', scores: { N: 3 } },
        { id: 'q30c', label: '有点符合', scores: { N: 2 } },
        { id: 'q30d', label: '不太符合', scores: { N: 1 } },
        { id: 'q30e', label: '完全不符合', scores: { N: 0 } }
      ]
    }
  ],
  ...
  // ────────────────────────────────────────────────────────
  // 12 种人格结论
  // matchRules: 各维度得分 >= 阈值时命中 (满分各24分, 阈值14=偏高 / 10=中等)
