  ...
  results: [
    ...
    // ── 社恐 + 内耗高 + 整顿低 ──
    {
      ...
      description: [
        ...
        '你不怎么出现，消耗的能量几乎全用在了和自己假打上——打完还不一定赢。',
        '社恐+内耗+做事随缘，恭喜你解锁了当代人最贵的一种活法：精神上的穷游。'
      ],
    ...
    // ── 内耗高 + 整顿高 ──
    {
      ...
      description: [
        ...
        '你的待办清单是人生驱动器，你的焦虑是燃料，唯一的问题是这台发动机从没停过，也忘了保养。',
        '你已经很强了。拜托了，给自己一个99分就行，那1分留给人类尊严。'
      ],
    ...
    // ── 存在感极低（低S+低E+低C但非绝对零分）──
    {
      ...
      description: [
        ...
        '你不引起纷争，不制造波澜，不给任何人添麻烦——你对这个世界最大的贡献是：从未妨碍过任何人。',
        '路人丙。NPC中的NPC。填充用人形道具正在努力发育中——这不是批评，只是……观察记录。'
      ],
    ...
    // ── 三低 ──
    {
      ...
      description: [
        ...
        '你不是不回消息，你是已经把“存在感”这个功能彻底卸载了，连回收站也是空的。',
