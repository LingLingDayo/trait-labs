...
export const chaosTest: TestSuite = {
  ...
  results: [
    ...
    // ── 整顿极高 + 社牛中 + 内耗几乎为零 ──
    {
      ...
      color: '#44403C',
      description: [
        '恭喜你，你是真正意义上的顶级牛马。执行力让人发指，社交维系也有，而你自己早已不在考虑范围之内。',
        '老板还没开口，你的方案已经写到了明年。你不是在上班，你就是工作本身的人形具象化。',
        '温馨提示：你叫什么名字？上次休息是什么时候？你还记得吗？'
      ],
    ...
    // ── 社牛高 + 内耗中 + 整顿低 ──
    {
      id: 'talker',
      title: '嘴炮巨人',
      subtitle: 'All Talk, No Plan',
      emoji: '🎤',
      color: '#FB923C',
      description: [
        '你是那种「说起来一套一套的，做起来……等等先让我理清思路」的人。社交能力拉满，头脑风暴永远精彩，但PPT能做，计划能出，行动表未必跟得上。',
        '不是你不行，是你的表达能力跑得比执行力快太多了。你能聊透任何问题，但聊完该干嘛还是该干嘛。',
        '建议你下次把「我觉得我们可以……」换成「我来做第一步」，效果会完全不一样。'
      ],
      strengths: ['口才一流', '点子永不断', '自带说服力', '气氛担当'],
      growthTips: ['说完就动手', '少规划多行动', '闭嘴做一件事试试'],
    ...
    // ── 渣男型（高社牛 + 低整顿 + 低内耗） ──
    {
      ...
      description: [
        ...
        '你让身边的人又爱又气，你自己也知道，但当下的感觉太好了，所以暂时还没打算改。（我们不评价你）'
      ],
