...
export const chaosTest: TestSuite = {
  ...
  // 分数区间说明 (每维度最高约 32分):
  //   高: >= 20  中: 10~19  低: < 10
  // matchRules: 各维度 >= 阈值时命中, 取命中分最多的结论
  // ────────────────────────────────────────────────────────
  results: [
    // ── 社牛高 + 内耗低 + 整顿高 ──
    {
      ...
      description: [
        ...
        '你同时兼顾每个人的情绪，吃饭提醒喝水，争吵当场拉架，有你在大家都莫名其妙地心里踏实。',
        '但别忘了：妈妈也需要被照顾一下喵。'
      ],
    ...
    // ── 社牛高 + 内耗低 + 整顿低 ──
    {
      ...
      color: '#FF6B9D',
      description: [
        '你是那种「我不知道我在干嘛但我玩得很爽」的人。社交能力拉满，计划等于没有，但偏偏就是活得很快乐。',
        '你的朋友圈每天都有新剧情，你不主动但你永远是话题制造机。没有人知道你下一步要做什么，包括你自己。',
        '建议你偶尔想想后天，最多三天就够了喵。'
      ],
    ...
    // ── 社恐 + 内耗低 + 整顿高 ──
    {
      ...
      description: [
        ...
        '唯一的问题是你偶尔让别人搞不清你到底在想什么，神秘感有点过量了喵。'
      ],
    ...
    // ── 三低 ──
    {
      ...
      color: '#CBD5E1',
      description: [
        '你存在，但不怎么存在。你看微信，你读消息，但你不怎么回。你活在某个平行时空里，对这个世界保持着礼貌的距离。',
        '不是你不好，是你更喜欢做一个观察者而不是表演者。',
        '但偶尔出来吱一声，大家会很高兴的喵——他们真的以为你蒸发了。'
      ],
    ...
    // ── 渣男型（高社牛 + 低整顿 + 低内耗） ──
    {
      id: 'chaoman',
      title: '渣男/渣女',
      subtitle: 'The Heartbreaker',
      emoji: '💔',
      color: '#FF8FA3',
      description: [
        '你魅力四射，活得很爽，但偶尔有那么一点……不太考虑别人感受。',
        '不是说你是坏人——你只是享受当下，沉迷体验，不太喜欢被规则约束，也不喜欢解释。',
        '你让身边的人又爱又气，你自己也知道，但当下的感觉太好了，所以暂时还没打算改喵。（我们不评价你）'
      ],
      strengths: ['魅力超强', '享乐天才', '活在当下', '横扫一片'],
      growthTips: ['想想别人的感受', '稍微稳重一点点', '真的只要一点点就够了'],
    ...
    // ── 默认兜底 ──
    {
      ...
      description: [
        ...
        '也许你自己都搞不清自己是什么类型，但这本身就是一种类型：谜之生命体喵。'
      ],
